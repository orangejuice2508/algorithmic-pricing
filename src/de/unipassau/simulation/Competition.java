...
abstract class Competition {
    ...
    /*
     For the detailed export, the numbers have to rounded to integers because otherwise Java throws a heap space
     is thrown.
     */
    private final List<Integer> pricesForDetailedExport = new ArrayList<>();
    private final List<Integer> quantitiesForDetailedExport = new ArrayList<>();
    private final List<Integer> profitsForDetailedExport = new ArrayList<>();
    ...
    /**
     * @param numberOfFirms number of all competing firms
     * @return the weighted price/quantity in the Nash equilibrium for the corresponding number of all competing firms
     */
    public abstract double getScaledNashEquilibrium(int numberOfFirms);

    /**
     * @param independentVariablesOfOtherFirms prices or quantities of the other firms, depending on the type of
     *                                         competition.
     * @return the scaled best response (price/quantity) to the other firms' prices/quantities.
     */
    public abstract double getScaledBestResponse(Integer[] independentVariablesOfOtherFirms);
    ...
    void setPrice(double price) {
        this.price = price;
        prices.add(price);
        pricesForDetailedExport.add((int) price);
    ...
    void setQuantity(double quantity) {
        ...
        quantitiesForDetailedExport.add((int) quantity);
    ...
    public void addProfit(double profit) {
        profits.add(profit);
        profitsForDetailedExport.add((int) profit);
    ...
    /**
     * @return all prices of the firm rounded to an integer.
     */
    public List<Integer> getPricesForDetailedExport() { return pricesForDetailedExport; }

    /**
     * @return all quantities of the firm rounded to an integer.
     */
    public List<Integer> getQuantitiesForDetailedExport() {
        return quantitiesForDetailedExport;
    }

    /**
     * @return all profits of the firm rounded to an integer.
     */
    public List<Integer> getProfitsForDetailedExport() { return profitsForDetailedExport; }
