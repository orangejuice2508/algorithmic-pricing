...
abstract class SimulationRun {
    ...
    private int numberOfDeviations; // Tells whether the deviation was already invoked
    ...
    /**
     * @return number of invoked deviations in this simulation run
     */
    ...
    /**
     * Increments the number of invoked deviations in this simulation run by one
     */
    public void incrementNumberOfDeviations() {
